...
button.addEventListener('click', function () {
    ...
    axios({
        method: 'get',
        url: 'http://openAPI.seoul.go.kr:8088/594c4d735773756e3336646f556379/json/RealtimeCityAir/1/99/'
    }).then((response) => {
    ...
    // xhr.open('get', 'http://openAPI.seoul.go.kr:8088/594c4d735773756e3336646f556379/json/RealtimeCityAir/1/99/', true)
    // xhr.onload = function () {
    //     let result = shr.responseText
