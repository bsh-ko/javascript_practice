...
// 생성자 함수가 아닌 이상.. 
// 혹은 어떤 객체에 동적 바인딩되어 실행될 함수가 아닌 이상
// 함수 내에 this는 쓰지 않는 것이 좋다.
...
// 위 객체와 함수는 별개이다
// 의도하에 함수를 obj1 객체 안에 선언된 것처럼 돌리고 싶아
...
//사례 ) 
//어떤 함수가 있고, 객체가 있음
//함수는 객체의 멤버로 준비되지 않은 별개의 함수
//마치 자신의 멤버로 등록된 함수처럼 사용하고 싶다면 ? 
 ...
 * Array에 push, pop, shift함수가 원래 있지 않나? Array에 선언된 함수이지만 ...
 * 위 유사 배열 객체에 따로 정의할 필요가 있을까?
 * 마치 나의 객체에 있는 함수처럼 연결해서 사용하면 되지 않을까? 
 * 
 * 아래의 myArray2처럼 변형해보았다.
 */
